...
const BackCard = ({
  ...
  const handleUnnasingClick = async () => {
    try {
      ...
      const request = await fetch(`${API.base}device/unassing/${device}`, {
        method: "PATCH",
        headers: {
  ...
  const handleSelectClick = async (item) => {
    try {
      ...
      const request = await fetch(`${API.base}device/resignDevice/`, {
        method: "POST",
  ...
  const getPerson = async () => {
    try {
      ...
      const request = await fetch(
        `${API.base}persons?page=${currentPage}&limit=${usersPerPage}&search=${search}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
